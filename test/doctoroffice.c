 ...
 */	
	...
	if(patientExamSheet[myIndex].treatment[0]=='X')
	{
		...
		Wait(xRayInteractionPatCV[patientExamSheet[myIndex].xRayRoom],xRayInteractionLock[patientExamSheet[myIndex].xRayRoom]);
		...
		Signal(xRayInteractionPatCV[patientExamSheet[myIndex].xRayRoom],xRayInteractionLock[patientExamSheet[myIndex].xRayRoom]);
